...
public class TelaListagem extends javax.swing.JFrame {
	...
	public TelaListagem(String[] user) throws IOException {
		TelaListagem.user = user;
		initComponents();
		nomeUsuario = "";
		for (String s : user) {
		...
		if (contatos == null) contatos = new ArrayList<Contato>();
		else {
	...
	public static void main(String[] user) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(TelaListagem.class.getName()).log(java.util.logging.Level.SEVERE, null,
					ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					new TelaListagem(user).setVisible(true);
				} catch (IOException e) {
					e.printStackTrace();
				}
			}
